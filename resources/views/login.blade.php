...
<!-- Mirrored from demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/auth-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Jun 2024 16:41:31 GMT -->
<head>
    <meta charset="utf-8" />
      ...
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
          ...
          <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use>
              ...
              <span class="app-brand-text demo text-body fw-bold">OX university Admin panel</span>
            </a>
          </div>
          <!-- /Logo -->
          ...
          <form id="formAuthentication" class="mb-3" method="post" name="loginfrm">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
              <button class="btn btn-primary d-grid w-100 sb_btn" type="button">Sign in</button>
